# Readme for ipvanish.sh script
# Script to install and use the IPVanish VPN Service with Linux versions, Specifically Raspberry Pi LibreELEC/Kodi
...
# 
# The following 3 lines to go into your
# /storage/.config/autostart.sh file.
...
# Yes, include the "&" at the end to make it run in the background and so
# it doesn't hold your boot process up waiting for it to finish.
(
  /storage/ipvanish.sh
) &
# 
